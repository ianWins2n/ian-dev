const FacebookIcon = () => {
  return (
    <a
      href="https://www.facebook.com/ian.monsanto1/"
      target="_blank"
      aria-label="Go to Ian Monsanto's Facebook Page"
    >
      <svg
        className="w-12 group"
        viewBox="0 0 1024 1024"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          className="duration-200 ease-in-out fill-neutral-300 group-hover:fill-white"
          fill="#000000"
